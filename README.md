...
Primera carga: **6 peticiones, 59,5 KB sin comprimir**. Incumplimientos de
accesibilidad detectados por axe-core: **0**, sobre 7 páginas × 4 entornos.
...
Las páginas las saca del `sitemap.xml` compilado, así que audita exactamente
lo que se publica. Si añades un proyecto, se audita solo.
